...
* **Sound processor**: Additive synthesizer with 16 sine wave oscillators.
...
* Emulator (`brus16_cpu.c`, `brus16_emu.c`, `brus16_sfx.c`): software model of the console using the SDL3 library.
...
* **Звуковой процессор**: Аддитивный синтезатор с 16 синусоидальными осцилляторами.
...
* Эмулятор (`brus16_cpu.c`, `brus16_emu.c`, `brus16_sfx.c`): Программная модель приставки с использованием библиотеки SDL3.
