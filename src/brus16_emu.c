...
const SDL_Scancode scancodes[KEY_NUM][2] = {
    ...
    {SDL_SCANCODE_I, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_K, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_J, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_L, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_7, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_8, SDL_SCANCODE_UNKNOWN},
    {SDL_SCANCODE_9, SDL_SCANCODE_UNKNOWN},
...
SDL_AppResult SDL_AppIterate(void *appstate) {
    ...
    while (emu->ticks_acc >= SDL_NS_PER_SECOND) {
        ...
        emu->cpu.wait = 0;
        sfx_update(&emu->cpu.data[OSC_MEM], &emu->sfx);
