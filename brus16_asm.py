...
COMMANDS = {
    ...
    ('ADD', 1): (F2, 0, ISA.OP_ADD, 1, IMM9),
    ('SUB', 1): (F2, 0, ISA.OP_SUB, 1, IMM9),
    ('MUL', 1): (F2, 0, ISA.OP_MUL, 1, IMM9),
    ('AND', 1): (F2, 0, ISA.OP_AND, 1, IMM9),
    ('OR', 1): (F2, 0, ISA.OP_OR, 1, IMM9),
    ('XOR', 1): (F2, 0, ISA.OP_XOR, 1, IMM9),
    ('SHL', 1): (F2, 0, ISA.OP_SHL, 1, IMM9),
    ('SHR', 1): (F2, 0, ISA.OP_SHR, 1, IMM9),
    ('SHRA', 1): (F2, 0, ISA.OP_SHRA, 1, IMM9),
    ('EQ', 1): (F2, 0, ISA.OP_EQ, 1, IMM9),
    ('NEQ', 1): (F2, 0, ISA.OP_NEQ, 1, IMM9),
    ('LT', 1): (F2, 0, ISA.OP_LT, 1, IMM9),
    ('LE', 1): (F2, 0, ISA.OP_LE, 1, IMM9),
    ('GT', 1): (F2, 0, ISA.OP_GT, 1, IMM9),
    ('GE', 1): (F2, 0, ISA.OP_GE, 1, IMM9),
    ('LTU', 1): (F2, 0, ISA.OP_LTU, 1, IMM9),
    ('LOAD', 1): (F2, 0, ISA.OP_LOAD, 0, IMM9),
    ('STORE', 1): (F2, 0, ISA.OP_STORE, 0, IMM9),
    ('GET_LOCAL', 1): (F2, 0, ISA.OP_LOAD, 1, IMM9),
    ('SET_LOCAL', 1): (F2, 0, ISA.OP_STORE, 1, IMM9),
    ('LOCALS', 1): (F2, 0, ISA.OP_LOCALS, 1, IMM9),
    ('SET_FP', 0): (F2, 0, ISA.OP_SET_FP, 0, 0),
    ('RET', 1): (F2, 0, ISA.OP_RET, 1, IMM9),
